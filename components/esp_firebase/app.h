...
class FirebaseApp {
   ...
   public:
    ...
    /**
     * @brief Standard http request. Use after firebaseClientInit(). response
     * stored in local_response_buffer.
     *
     ...
     */
    http_ret_t performRequest(const char* url, esp_http_client_method_t method,
